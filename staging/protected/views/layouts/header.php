...
<html>
    <head>
        ...
        <!-- <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/default/custom-scroller.js" type="text/javascript" language="javascript"></script> -->
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/default/owl.transitions.css">
        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/default/publish.css">
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/default/jquery.dropdown.js" type="text/javascript" language="javascript">

        </script>
        <script>
            $(document).ready(function () {
                $('#autopopulate').css('display', 'none');
                $('#loader_image1').show();
                ...
                <nav id="navigation">
                    ...
                    <?php if ($this->cookieLangType == 'Chinese') { ?>
                        <ul>
                            ...
                            <li class="submenu-list-item"><a class="<?php if ($this->action->id == 'store' || $this->action->id == 'customerservice') {
                        echo 'active';
                    } else {
                        echo '';
                    }; ?>" >为您服务</a>  
...
<?php if (!empty($this->menuTab) && $this->menuTab['language'] == 'show') { ?>
    ...
    ?> </button>
            ...
            <div id="loader_image1" style ="text-align: center;"></div>

            <?php
            if (strpos($_SERVER['REQUEST_URI'], $this->langType . '/brand-history') != false) {
                ?>
                <div class="history-bg">
                    <div class="container" id ="autopopulate">
                        <?php
                        echo $content;
                        ?>
                    </div></div>
                <?php
            } else if (strpos($_SERVER['REQUEST_URI'], $this->langType . '/news') != false) {
                ?>
                ...
                <?php
            } else if (strpos($_SERVER['REQUEST_URI'], $this->langType . '/collections') != false) {
                ?>
                ...
                <?php
            } else if (strpos($_SERVER['REQUEST_URI'], $this->langType . '/store') != false) {
                ?>
                ...
                <?php
            } else if (strpos($_SERVER['REQUEST_URI'], $this->langType . '/contact-us') != false) {
                ?>
                ...
                <?php
            } else if (strpos($_SERVER['REQUEST_URI'], $this->langType . '/customer-service') != false) {
                ?>
...
<?php } ?>
<?php if ($this->cookieLangType == 'Chinese') { ?>
                <div class="footer_left">&copy; <?php echo date('Y'); ?>龙马珍公司 | <?php echo CHtml::link('法律', array($this->langType . '/legal')); ?></div>
<?php } ?>
<?php if ($this->cookieLangType == 'Chinese') { ?>
...
<?php } ?>
            ...
            <script>
                ...
                $(document).ready(function () {
                    $.when($('#loader_image1').fadeOut(300))
                            .done(function () {
                                $('#autopopulate').fadeIn();
                            });
            ...
            <style>
                #loader_image1{background: url(../images/loader.gif) no-repeat center center; height: 350px; }
            </style>
