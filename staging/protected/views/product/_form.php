...
<style>.errormsg{ color:#f00; clear: both; text-align: left; padding-left:2px!important; }
...
<div class="form">
    ...
    <div class="col-sm-12 ">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 required"> <label >Collection<span class="required"> *</span></label></div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3  "> <label >Product Model<span class="required"> *</span></label></div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3  ">  <label class ="required">Product Image<p style="color:red;">(size should be 252px × 379px)</p></label></div>
            <div class="col-xs-12 col-sm-6 col-md-9 "> <?php echo CHtml::activeFileField($model, 'product_image', array('maxlength' => 255)); ?> 
                <div id="errormsgProductImage" class="errormsg"></div></div>
    ...
    <div class="col-sm-12  col-sm-12 " >
        <div class="col-xs-12 lang-cat1" style="text-align:left;">Product Specifications</div>
    ...
    <div class="row"> 
        <div class="col-sm-6 ">
            ...
            <div class="col-sm-12  col-sm-12 " ><div class=" col-xs-12 col-sm-12  lang-cat2">CN</div></div>
        ...
        <div class="col-sm-6 ">
            <div class="col-sm-12  col-sm-12 " ><div class=" col-xs-12 col-sm-12  lang-cat2">EN</div></div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6  ">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6  ">   <?php echo CHtml::Button('Add', array('onclick' => 'return send();', 'class' => 'black-btn ')); ?> </div>
        </div>
...
//        }
        ...
        else if (!product_image.match(/\.(jpg|jpeg|png|gif)$/))
        {
        ...
        if (error == false) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo Yii::app()->createAbsoluteUrl("product/create"); ?>',
                data: formData,
                contentType: false,
                processData: false,
