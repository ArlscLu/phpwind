...
<div class="form-container">
    <div class="form-left-section">
        ...
        <?php if (strtolower($this->cookieLangType) == 'chinese') { ?> <h2><span style="font-family:arial;">OLMA</span>客服服务</h2> <?php } ?> 
        <?php
        if (!empty($getContent)) {
            ?>
    ...
    <div class="form-right-section">
        ...
        <?php if (strtolower($this->cookieLangType) == 'chinese') { ?>
            ...
            <form id="contact-form">
                <p>欢迎您前往附近的奥玛品牌店铺或维修中心，或者随时与我们联系了解更多相关信息。<br></p>
                <div class="contact-row">
                ...
                <div class="contact-row">
                    <div class="squaredFour">
                        <input type="checkbox"  name="check" id="squaredFour" value="None">                   
                        <label for="squaredFour"></label><span>同意接收奥尔马发送的电子邮件更新及其他信息</span>
                    </div>
                    <div id="errors" class="errormsg"></div>
                </div>
