...
$this->widget('zii.widgets.CDetailView', array(
    ...
    'attributes' => array(
        ...
        array(
             'name' => 'Banner Image (En)',
            'type' => 'raw',
            'value' => CHtml::image(Yii::app()->baseUrl . "/images/upload/" . $model->banner_image_eng, 'alt', array("width" => "50%"))
        ),
        array(
             'name' => 'Banner Image (Cn)',
            'type' => 'raw',
            'value' => CHtml::image(Yii::app()->baseUrl . "/images/upload/" . $model->banner_image_chi, 'alt', array("width" => "50%"))
        ),
    ),
));
?>
