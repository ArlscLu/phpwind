...
<div class="form">
    ...
    <div class="row"> 
        ...
        <div class="col-xs-12 col-sm-6 col-md-6  "> <input type ="text" name ="content_title_C" id ="content_title_C" value ="<?php echo $model->content_title_C_A; ?>" >
     ...
     <div class="col-xs-12 col-sm-12 col-md-12  "><textarea name="content_C" id="content_C" class="editor"><?php echo $model->content_C_A; ?>
        </textarea>
	   ...
	   <div class="col-xs-12 col-sm-6 col-md-6  ">	
        ...
        <div class="col-xs-12 col-sm-6 col-md-6  ">	 <input type ="text" name ="content_title_E" id ="content_title_E" value ="<?php echo $model->content_title_E_A; ?>">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12  ">	 <textarea name="content_E" id="content_E" class="editor"><?php echo $model->content_E_A; ?>
        </textarea>
...
//            formData.append('ajax', $form.prop('id'))
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo Yii::app()->createAbsoluteUrl("content/update?id=".$model->id); ?>',
                data: formD,
