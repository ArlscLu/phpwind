...
//                'minDate' => 0,
	  ...
	  <div class="clearfix"></div>
        ...
        <div id="news_image" class="errormsg"></div>
        <?php if ($model->news_image != '' && !empty($model->news_image)) { ?>
            <div class="">
                <?php echo CHtml::image(Yii::app()->request->baseUrl . '/images/upload/news/' . $model->news_image, "news_image", array("width" => 200)); ?>
            </div>
        <?php } ?> </div>
...
<!--        <div class="col-xs-12 col-sm-6 col-md-6  "> <?php // echo $form->labelEx($model, 'news_title_C'); ?></div>
        ...
        <div id="news_header_C" class="errormsg"></div></div>
		  ...
		  <div class="col-xs-12 col-sm-12 col-md-12  "><label >Part 1<span class="required"> *</span></label></div>
...
//            }
            ...
            else if (!News_news_image.match(/\.(jpg|jpeg|png|gif)$/))
            {
            ...
            if (error == false) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '<?php echo Yii::app()->createAbsoluteUrl("news/create"); ?>',
                    data: formData,
                    contentType: false,
                    processData: false,
