...
<div class="row">
 ...
 <div class="col-xs-12 col-sm-6 "> <div class="col-xs-12 col-sm-6 ">
        <label>&nbsp;</label></div>
       <div class="col-xs-12 col-sm-6 "> <?php echo CHtml::Button('Add', array('onclick' => 'return send();', 'class' => 'black-btn ')); ?> 
    </div></div>
...
//        }
        ...
        else if (!banner_image_eng.match(/\.(jpg|jpeg|png|gif)$/))
        {
        ...
        else if (!banner_image_chi.match(/\.(jpg|jpeg|png|gif)$/))
        {
        ...
        else if (!banner_mobile_image.match(/\.(jpg|jpeg|png|gif)$/))
        {
        ...
        if (banner_mobile_image_chi == '') {
            $('#errormsgMobileCN').html('Please upload chinese mobile banner');
            error = true;
           
        }
        else if (!banner_mobile_image_chi.match(/\.(jpg|jpeg|png|gif)$/))
        {
        ...
        if (error == false) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo Yii::app()->createAbsoluteUrl("banner/create"); ?>',
                data: formData,
                contentType: false,
                processData: false,
